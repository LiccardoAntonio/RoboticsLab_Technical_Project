...
public:
    ...
    KDLPlanner(double _trajDuration, double _accDuration, Eigen::Vector3d _trajInit, double _rectWidth, double _rectHeight);
    ...
    trajectory_point compute_rectangular_trajectory(double s, double s_dot, double s_ddot);
    ...
    trajectory_point rectangular_traj_cubic(const double t);
    trajectory_point rectangular_traj_trapezoidal(const double t);
