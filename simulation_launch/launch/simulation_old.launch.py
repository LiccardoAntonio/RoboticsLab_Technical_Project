...
def generate_launch_description():
    ...
    # Get the leonardo_race_field world from ros2_fra2mo package
    fra2mo_pkg_path = get_package_share_directory('ros2_fra2mo')
    simulation_package_path = get_package_share_directory('simulation_launch')
    models_path = os.path.join(fra2mo_pkg_path, 'models')

    world_file = os.path.join(fra2mo_pkg_path, "worlds", "leonardo_race_field.sdf")
    ...
    xacro_file = os.path.join(fra2mo_pkg_path, "urdf", "fra2mo.urdf.xacro")
    models_path = os.path.join(fra2mo_pkg_path, 'models')
    world_file  = os.path.join(simulation_package_path, "world", "pallet_station.sdf")
    ...
    # Set GZ_SIM_RESOURCE_PATH so Gazebo can find the models
